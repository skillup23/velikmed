...
export default function Doctors() {
  ...
  return (
    <div className="flex flex-col">
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 animate-simple">
        {isDoctors.map(({ id, fio, spec, workYear, foto }) => {
          return (
            <div
              key={id}
              className="pt-6 md:pt-8 px-6 flex flex-col items-start justify-between bg-white rounded-xl overflow-hidden gap-[10px] md:gap-3 animate-simple"
            >
